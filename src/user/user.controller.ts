import { Controller, Put, UseGuards, Body, Res, HttpStatus } from "@nestjs/common";
...
export class UserController {
    ...
    async putPassword(@Body() body: UpdatePasswordDto, @Res() res: Response) {
        try {
            await this._userService.updatePassword(res.locals.user["user_id"], body.current, body.update);
